...
class DronesResourceTests {
    ...
    void testReadPass() {
        ...
        Assert.isTrue(droneRecord.getSerialNumber().equalsIgnoreCase("DRD2-002"), "could");
    }
    ...
    void testReadAllByState() {
        ...
        Assert.isTrue(droneRecords.getNumberOfElements() == 2, "Number of records have to be 2 it is currently " + droneRecords.getNumberOfElements());
